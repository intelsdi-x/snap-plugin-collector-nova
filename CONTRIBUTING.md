...
* Whether your contribution is for a bug fix or a feature request, **create an [Issue](https://github.com/intelsdi-x/snap-plugin-collector-nova/issues)** and let us know what you are thinking.
...
We always want better description of metrics, see [here](https://github.com/intelsdi-x/snap-plugin-collector-nova/blob/master/METRICS.md), feel free to add something or correct.
